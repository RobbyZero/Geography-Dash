        ...
        timer.after(500, function () {
            ...
            mainMenu.onButtonPressed(controller.A, function (selection, selectedIndex) {
                ...
                game.setDialogFrame(img`
                    ...
                    ..bbbbbbbbbbbbbbbbbbbb..
                    `)
                game.showLongText("Use mouse to move cursor                  Right click to open menu                           Left click over a blue dot to select                                        Race to get as many right as you can!", DialogLayout.Full)
